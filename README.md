# 🛡️ GhastVPN — Telegram-бот и Mini Apps для выдачи VPN-ключей (VLESS)
...
1. 💳 **Покупка ключа** через ТБАНК, Юкасса
2. 📣 **Встроенные рассылки** по базе пользователей
...
🚀 Готовый Mini Apps совместно с ботом! Заходи проверяй!

Этот Mini App позволяет:
- Подключать оплату через ТБАНК, Юкасса и многое другое
- Упрощать управление и приобритение ключей
- Использовать бэкенд-связку с Remna.st

---

## 🔗 Попробовать прямо сейчас

👉 [Открыть @GhastVPN_BOT](https://t.me/superiorvpnbot)
